...
// ---- CDN library entry points (tfjs, blazeface, onnxruntime-web, exifr, tesseract.js) ----
const CDN_ASSETS = [
...
const MODEL_ASSETS = [
  ...
  // OCR language data for the Text/Logo Check (~4MB, the smaller "fast"
  // tessdata variant -- validated to give identical results to the much
  // larger "best" variant on real test photos, see chat).
  'https://raw.githubusercontent.com/kshitij435/cattle/main/eng.traineddata',
];
